 ...
 */
function callableInfoGetReturnAttribute(info: CallableInfo, name: string | null): string | null
/**
 ...
 */
function enumInfoGetErrorDomain(info: EnumInfo): string | null
/**
 ...
 * @returns the symbol
 */
function functionInfoGetSymbol(info: FunctionInfo): string | null
/**
 ...
 * @returns the string
 */
function infoTypeToString(type: InfoType): string | null
/**
 ...
 */
function interfaceInfoFindMethod(info: InterfaceInfo, name: string | null): FunctionInfo
/**
 * TODO
 * @param info a #GIInterfaceInfo
 ...
 */
function interfaceInfoFindSignal(info: InterfaceInfo, name: string | null): SignalInfo
/**
 ...
 */
function interfaceInfoFindVfunc(info: InterfaceInfo, name: string | null): VFuncInfo
/**
 ...
 * @returns the #GIFunctionInfo. Free the struct by calling g_base_info_unref() when done.
 */
function objectInfoFindMethod(info: ObjectInfo, name: string | null): FunctionInfo | null
/**
 ...
 * @returns the #GIFunctionInfo. Free the struct by calling g_base_info_unref() when done.
 */
function objectInfoFindMethodUsingInterfaces(info: ObjectInfo, name: string | null): [ /* returnType */ FunctionInfo | null, /* implementor */ ObjectInfo ]
/**
 * TODO
 * @param info a #GIObjectInfo
 * @param name Name of signal
 * @returns Info for the signal with name @name in @info, or %NULL on failure.
 */
function objectInfoFindSignal(info: ObjectInfo, name: string | null): SignalInfo | null
/**
 ...
 * @returns the #GIVFuncInfo, or %NULL. Free it with g_base_info_unref() when done.
 */
function objectInfoFindVfunc(info: ObjectInfo, name: string | null): VFuncInfo | null
/**
 ...
 * @returns the #GIVFuncInfo. Free the struct by calling g_base_info_unref() when done.
 */
function objectInfoFindVfuncUsingInterfaces(info: ObjectInfo, name: string | null): [ /* returnType */ VFuncInfo | null, /* implementor */ ObjectInfo ]
/**
 ...
 */
function objectInfoGetTypeInit(info: ObjectInfo): string | null
/**
 * Obtain the name of the objects class/type.
 * @param info a #GIObjectInfo
 * @returns name of the objects type
 */
function objectInfoGetTypeName(info: ObjectInfo): string | null
/**
 ...
 */
function registeredTypeInfoGetTypeInit(info: RegisteredTypeInfo): string | null
/**
 ...
 */
function registeredTypeInfoGetTypeName(info: RegisteredTypeInfo): string | null
/**
 ...
 */
function structInfoFindField(info: StructInfo, name: string | null): FieldInfo
/**
 ...
 */
function structInfoFindMethod(info: StructInfo, name: string | null): FunctionInfo
/**
 ...
 * @returns the string
 */
function typeTagToString(type: TypeTag): string | null
/**
 * Obtain the type information for method named `name`.
 ...
 * @returns the #GIFunctionInfo, free it with g_base_info_unref() when done.
 */
function unionInfoFindMethod(info: UnionInfo, name: string | null): FunctionInfo
/**
